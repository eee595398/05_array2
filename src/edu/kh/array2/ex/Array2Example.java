...
public class Array2Example {
	...
	public void ex1() {
		...
		arr = new int[2][3];
		// heap 영역에 int 2차원 배열 2행 3일 공간을 할당
		...
		// 2) 중 for문을 이용한 초기화
		int num =10;// 배열 요소 초괴화에 사용할 변수
		// 배열 길이
		// 배열명.length는 변수가 직접참조 하고 있는 배열의 길이를 반환
		
		System.out.println(arr.length); ///2 (행의 길이) 
		//arr이 참조하고 있는 2차원 배열의 행의 길이
		System.out.println(arr[0].length); // 3(열결이)
		//
		System.out.println(arr[1].length); // 3(열결이)
	...
	public void ex3() {
		...
		// 나중에 서로 크기가 다른 1차원 배열 생성하여 참조하는 배열
